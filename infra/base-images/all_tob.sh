...
#   docker build -t ghcr.io/tob-challenges/base-builder-rust "$@" infra/base-images/base-builder-rust
#   docker build -t ghcr.io/tob-challenges/base-builder-ruby "$@" infra/base-images/base-builder-ruby
