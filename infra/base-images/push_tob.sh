...
push ghcr.io/tob-challenges/base-builder-rust "${version}"
push ghcr.io/tob-challenges/base-builder-ruby "${version}"
push ghcr.io/tob-challenges/base-builder-swift "${version}"
push ghcr.io/tob-challenges/base-runner "${version}"
push ghcr.io/tob-challenges/base-runner-debug "${version}"
